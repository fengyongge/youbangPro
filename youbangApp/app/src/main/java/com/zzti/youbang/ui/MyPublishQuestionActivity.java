...
public class MyPublishQuestionActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, RefreshLayout.OnLoadListener {
    ...
    MyPublishQuestionActivity.Adapter adapter;
    private Dialog windowsBar = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_publish_question);
        ...
        RetrofitManager.getInstance().createReq(JavaApi.class).getQuestion()
                ...
                .subscribe(new Subscriber<BaseResponse<QuestionManageBean>>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        StringUtils.showToast(MyPublishQuestionActivity.this, e.getMessage());
    ...
    public void onLoad() {
        ...
        if (noMoreData == true) {
            StringUtils.showToast(MyPublishQuestionActivity.this, "没有更多");
            rlSwipe.setLoading(false);
        } else {
            isRefresh = false;
            isLoading = true;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.llItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(MyPublishQuestionActivity.this, QuestionDetailActivity.class);
            ...
            viewHolder.cvImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(MyPublishQuestionActivity.this, HomePageActivity.class);
